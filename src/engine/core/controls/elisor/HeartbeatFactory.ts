module engine {
	export class HeartbeatFactory extends egret.HashObject {
		...
		public static _instance_:HeartbeatFactory;
		...
		public static getInstance():HeartbeatFactory
		{
			return HeartbeatFactory._instance_ = HeartbeatFactory._instance_ || new HeartbeatFactory();
		}
